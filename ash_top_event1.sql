--
-- Given a wait event, list the top objects and associated sql_ids WAITING for that event during the last_x_mins
--
accept event_str	prompt 'Enter Event Pattern: ' 
undef last_x_mins
@plusenv
col event 	format a32 	head 'Event Name'	trunc
col sql_id	format a13	head 'Sql Id'
col pct		format 999.9	head 'Pct'
col oname	format a40	head 'Object Name'	trunc
col stime_pdt	format a11	head 'Start PDT'
col etime_pdt	format a11	head 'End PDT'
