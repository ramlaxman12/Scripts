...
doc
        /*
        , lio_self
        , trunc(log(10,abs(case lio_self when 0 then 1 else lio_self end))) as power_10_lio_self
        , trunc(mod(log(10,abs(case lio_self when 0 then 1 else lio_self end)),3)) as power_10_lio_self_mod_3
        , reads_self
        , trunc(log(10,abs(case reads_self when 0 then 1 else reads_self end))) as power_10_reads_self
        , trunc(mod(log(10,abs(case reads_self when 0 then 1 else reads_self end)),3)) as power_10_reads_self_mod_3
        , writes_self
        , trunc(log(10,abs(case writes_self when 0 then 1 else writes_self end))) as power_10_writes_self
        , trunc(mod(log(10,abs(case writes_self when 0 then 1 else writes_self end)),3)) as power_10_writes_self_mod_3
        , e_rows_times_start
        , trunc(log(10,abs(case e_rows_times_start when 0 then 1 else e_rows_times_start end))) as power_10_e_rows_start
        , trunc(mod(log(10,abs(case e_rows_times_start when 0 then 1 else e_rows_times_start end)),3)) as power_10_e_rows_start_mod_3
        */
        /*, to_char(round(lio_self / power(10, power_10_lio_self - case when power_10_lio_self > 0 and power_10_lio_self_mod_3 = 0 then 3 else power_10_lio_self_mod_3 end)), 'FM99999') ||
          case power_10_lio_self - case when power_10_lio_self > 0 and power_10_lio_self_mod_3 = 0 then 3 else power_10_lio_self_mod_3 end
          when 0            then ' '
          when 1            then ' '
          when 3*1          then 'K'
          when 3*2          then 'M'
          ...
          when 3*5          then 'P'
          when 3*6          then 'E'
          else '*10^'||to_char(power_10_lio_self - case when power_10_lio_self > 0 and power_10_lio_self_mod_3 = 0 then 3 else power_10_lio_self_mod_3 end)
          end as lio_self_format2
        , to_char(round(reads_self / power(10, power_10_reads_self - case when power_10_reads_self > 0 and power_10_reads_self_mod_3 = 0 then 3 else power_10_reads_self_mod_3 end)), 'FM99999') ||
          case power_10_reads_self - case when power_10_reads_self > 0 and power_10_reads_self_mod_3 = 0 then 3 else power_10_reads_self_mod_3 end
          when 0            then ' '
          when 1            then ' '
          when 3*1          then 'K'
          when 3*2          then 'M'
          ...
          when 3*5          then 'P'
          when 3*6          then 'E'
          else '*10^'||to_char(power_10_reads_self - case when power_10_reads_self > 0 and power_10_reads_self_mod_3 = 0 then 3 else power_10_reads_self_mod_3 end)
          end as reads_self_format2
        , to_char(round(writes_self / power(10, power_10_writes_self - case when power_10_writes_self > 0 and power_10_writes_self_mod_3 = 0 then 3 else power_10_writes_self_mod_3 end)), 'FM99999') ||
          case power_10_writes_self - case when power_10_writes_self > 0 and power_10_writes_self_mod_3 = 0 then 3 else power_10_writes_self_mod_3 end
          when 0            then ' '
          when 1            then ' '
          when 3*1          then 'K'
          when 3*2          then 'M'
          ...
          when 3*5          then 'P'
          when 3*6          then 'E'
          else '*10^'||to_char(power_10_writes_self - case when power_10_writes_self > 0 and power_10_writes_self_mod_3 = 0 then 3 else power_10_writes_self_mod_3 end)
          end as writes_self_format2
        , to_char(round(e_rows_times_start / power(10, power_10_e_rows_start - case when power_10_e_rows_start > 0 and power_10_e_rows_start_mod_3 = 0 then 3 else power_10_e_rows_start_mod_3 end)), 'FM99999') ||
          case power_10_e_rows_start - case when power_10_e_rows_start > 0 and power_10_e_rows_start_mod_3 = 0 then 3 else power_10_e_rows_start_mod_3 end
          when 0            then ' '
          when 1            then ' '
          when 3*1          then 'K'
          when 3*2          then 'M'
          ...
          when 3*5          then 'P'
          when 3*6          then 'E'
          else '*10^'||to_char(power_10_e_rows_start - case when power_10_e_rows_start > 0 and power_10_e_rows_start_mod_3 = 0 then 3 else power_10_e_rows_start_mod_3 end)
          end as e_rows_times_start_format2*/
#