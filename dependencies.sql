-- This scripts prints all the dependencies(NOT dependents :) ) of a object. For instance, if we enter a view, it displays all the sub views, tables etc.. that are involved in that view directly or indeirectly.
set linesi 190
