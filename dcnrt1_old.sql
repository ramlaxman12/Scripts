  CREATE OR REPLACE FORCE VIEW VAS.SRW_INVENTORY_LEVEL_BY_OWNER (WAREHOUSE_ID, INVENTORY_OWNER_GROUP_ID, INVENTORY_CONDITION_CODE, ASIN, ON_HAND_QUANTITY, BOUND_QUANTITY, COMMITTED_QUANTITY, ALLOCATED_QUANTITY, UNALLOCATED_CUSTOMER_DEMAND) AS
  SELECT warehouse_id,
